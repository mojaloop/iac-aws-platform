...
output "k8s_master_nodes_private_ip" {
  value = module.k8s-cluster-main.master_nodes_private_ip
}
output "k8s_master_nodes_private_dns" {
  value = module.k8s-cluster-main.master_nodes_private_dns
}

output "k8s_worker_nodes_private_ip" {
  value = module.k8s-cluster-main.worker_nodes_private_ip
}

output "k8s_worker_nodes_private_dns" {
  value = module.k8s-cluster-main.worker_nodes_private_dns
}
