    ...
    extraEnvironments:
      ...
      hub-k8s-cgs-environment.json: {
        "inputValues": {
          ...
          "SIM1_BACKEND_TESTAPI_URL": "http://$release_name-sim-${internal_sim_prefix}testfsp1-backend:3003",
          "SIM2_BACKEND_TESTAPI_URL": "http://$release_name-sim-${internal_sim_prefix}testfsp2-backend:3003",
          "SIM3_BACKEND_TESTAPI_URL": "http://$release_name-sim-${internal_sim_prefix}testfsp3-backend:3003",
          "SIM4_BACKEND_TESTAPI_URL": "http://$release_name-sim-${internal_sim_prefix}testfsp4-backend:3003",
