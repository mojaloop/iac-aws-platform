    ...
    extraEnvironments:
      ...
      hub-k8s-default-environment.json: &ttkInputValues {
        "inputValues": {
          ...
          "PAYEEFSP_BACKEND_TESTAPI_URL": "http://$release_name-sim-${sim_prefix}payeefsp-backend:3003",
          "PAYEEFSP_CALLBACK_URL": "http://$release_name-sim-${sim_prefix}payeefsp-scheme-adapter:4000",
          "PAYEEFSP_SDK_TESTAPI_URL": "http://$release_name-sim-${sim_prefix}payeefsp-scheme-adapter:4002",
          "PAYEEFSP_SDK_TESTAPI_WS_URL": "ws://$release_name-sim-${sim_prefix}payeefsp-scheme-adapter:4002",
      ...
      ## FOR_CGS
      # hub-k8s-cgs-environment.json: &ttkInputValues {
      hub-k8s-cgs-environment.json: {
        "inputValues": {
          ...
          "PAYEEFSP_SDK_TESTAPI_URL": "http://$release_name-sim-${sim_prefix}payeefsp-scheme-adapter:4002",
          "PAYEEFSP_SDK_TESTAPI_WS_URL": "ws://$release_name-sim-${sim_prefix}payeefsp-scheme-adapter:4002",
          "PAYERFSP_BACKEND_TESTAPI_URL": "http://$release_name-sim-${sim_prefix}payerfsp-backend:3003",
          "PAYERFSP_CALLBACK_URL": "http://$release_name-sim-${sim_prefix}payerfsp-scheme-adapter:4000",
          "PAYERFSP_SDK_TESTAPI_URL": "http://$release_name-sim-${sim_prefix}payerfsp-scheme-adapter:4002",
          "PAYERFSP_SDK_TESTAPI_WS_URL": "ws://$release_name-sim-${sim_prefix}payerfsp-scheme-adapter:4002",
          "SIM1_JWS_KEY": "-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n",
          "SIM1_MSISDN": "17039811903",
          "SIM1_NAME": "testfsp1",
          "SIM2_JWS_KEY": "-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n",
          ...
          "TESTFSP1_JWS_PUB_KEY": "-----BEGIN PUBLIC KEY-----\\nUQIDAQAB\n-----END PUBLIC KEY-----\n",
          "TESTFSP2_JWS_PUB_KEY": "-----BEGIN PUBLIC KEY-----\\nAQIDAQAB\n-----END PUBLIC KEY-----",
          "TESTFSP1_BACKEND_TESTAPI_URL": "http://$release_name-sim-${sim_prefix}testfsp1-backend:3003",
          "TESTFSP1_CALLBACK_URL": "http://$release_name-sim-${sim_prefix}testfsp1-scheme-adapter:4000",
          "TESTFSP1_SDK_TESTAPI_URL": "http://$release_name-sim-${sim_prefix}testfsp1-scheme-adapter:4002",
          "TESTFSP1_SDK_TESTAPI_WS_URL": "ws://$release_name-sim-${sim_prefix}testfsp1-scheme-adapter:4002",
          "TESTFSP2_BACKEND_TESTAPI_URL": "http://$release_name-sim-${sim_prefix}testfsp2-backend:3003",
          "TESTFSP2_CALLBACK_URL": "http://$release_name-sim-${sim_prefix}testfsp2-scheme-adapter:4000",
          "TESTFSP2_SDK_TESTAPI_URL": "http://$release_name-sim-${sim_prefix}testfsp2-scheme-adapter:4002",
          "TESTFSP2_SDK_TESTAPI_WS_URL": "ws://$release_name-sim-${sim_prefix}testfsp2-scheme-adapter:4002",
          "TEST_NOTIFICATIONS": true,
          "TTKFSP_JWS_KEY": "-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n",
          "WS_ASSERTION_TIMEOUT": 5000,
          "accept": "application/vnd.interoperability.parties+json;version=1.0",
          ...
          "SIM1_BACKEND_TESTAPI_URL": "http://$release_name-sim-${sim_prefix}testfsp1-backend:3003",
          "SIM2_BACKEND_TESTAPI_URL": "http://$release_name-sim-${sim_prefix}testfsp2-backend:3003",
          "SIM3_BACKEND_TESTAPI_URL": "http://$release_name-sim-${sim_prefix}testfsp3-backend:3003",
          "SIM4_BACKEND_TESTAPI_URL": "http://$release_name-sim-${sim_prefix}testfsp4-backend:3003",
          ...
          "MSISDN_ORACLE_ENDPOINT": "http://$release_name-simulator/oracle",
          "NET_DEBIT_CAP": "50000",
          "HOST_REGISTER_ORACLE": "http://$release_name-simulator",
          "TESTFSP3_BACKEND_TESTAPI_URL": "http://$release_name-sim-${sim_prefix}testfsp3-backend:3003",
          "TESTFSP4_BACKEND_TESTAPI_URL": "http://$release_name-sim-${sim_prefix}testfsp4-backend:3003",
          "payeefspMSISDN": "17039811907",
          "payerfspMSISDN": "17891239876",
          "settlementpayeefspNoExtensionMSISDN": "27714923918",
          "TESTFSP3_CALLBACK_URL": "http://$release_name-sim-${sim_prefix}testfsp3-scheme-adapter:4000",
          "TESTFSP4_CALLBACK_URL": "http://$release_name-sim-${sim_prefix}testfsp4-scheme-adapter:4000",
