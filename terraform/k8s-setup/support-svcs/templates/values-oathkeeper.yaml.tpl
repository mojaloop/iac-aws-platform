...
fullnameOverride: "oathkeeper-keycloak"
      ...
      jwt:
        ...
        config:
          ...
          target_audience:
            - ${keycloak_audience}
          trusted_issuers:
            - https://${keycloak_host}/auth/realms/${keycloak_realm}
      oauth2_introspection:
        enabled: true
        config:
          introspection_url: "https://${keycloak_host}/auth/realms/${keycloak_realm}/protocol/openid-connect/token/introspect"
          introspection_request_headers:
            # Configure the following with base64 encoded string contains admin:password of wso2 server
            authorization: "Basic ${keycloak_admin_creds}"
    authorizers:
      allow:
        enabled: true
    mutators:
    ...
    [
      {
        ...
        "match": {
            ...
            "url": "http://oathkeeper-keycloak-api.keycloak.svc.cluster.local/<.*>"
        },
        "authenticators": [
            {
                "handler": "jwt"
...
maester:
  enabled: false
  oathkeeperFullnameOverride: 'oathkeeper-keycloak'
